...
function CardItem({ Nombre_Pelicula, Cod_Pelicula, pelicula }: Props) {
  ...
  return (
    <div className="w-full max-w-sm border-transparent rounded-lg shadow bg-[#24283b] p-2">
      <a href="#">
        <img
          className="p-8 rounded-t-lg"
          src="https://media.themoviedb.org/t/p/w220_and_h330_face/b0obWWCLRVRqRzlSK1LSGtADkLM.jpg"
          alt="product image"
        />
      </a>
